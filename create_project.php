...
<?php
    ...
    if (isset($_POST['project_title'])){
        ...
        $created_by = pg_escape_string($dbconn,$created_by);

        $query = "INSERT into public.project 
        (project_title, description, start_date, end_date, categories, target_amount, created_by) 
...
<input type="text" name="start_date" placeholder="Start Date: DD/MM/YY" required /><br>
<input type="text" name="end_date" placeholder="End Date: DD/MM/YY" required /><br>
...
<input type="text" name="created_by" placeholder="Your Email" required /><br>
